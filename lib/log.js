...
$root.Log = (function() {
    ...
    Log.encode = function encode(message, writer) {
        ...
        if (message.contents != null && message.contents.length)
            for (var i = 0; i < message.contents.length; ++i)
                $root.Log.Content.encode(message.contents[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        return writer;
    };
    ...
    Log.fromObject = function fromObject(object) {
        ...
        if (object.contents) {
            if (!Array.isArray(object.contents))
                throw TypeError(".Log.contents: array expected");
            message.contents = [];
            for (var i = 0; i < object.contents.length; ++i) {
                if (typeof object.contents[i] !== "object")
                    throw TypeError(".Log.contents: object expected");
    ...
    Log.toObject = function toObject(message, options) {
        ...
        if (message.contents && message.contents.length) {
            ...
            for (var j = 0; j < message.contents.length; ++j)
                object.contents[j] = $root.Log.Content.toObject(message.contents[j], options);
        }
        return object;
    };
    ...
    Log.Content = (function() {
         ...
         * @static
         * @param {Log.IContent=} [properties] Properties to set
         * @returns {Log.Content} Content instance
         */
        ...
        Content.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Log.Content();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Content.fromObject = function fromObject(object) {
            if (object instanceof $root.Log.Content)
                return object;
...
$root.LogGroup = (function() {
     ...
     * @static
     * @param {ILogGroup=} [properties] Properties to set
     * @returns {LogGroup} LogGroup instance
     */
    ...
    LogGroup.encode = function encode(message, writer) {
        ...
        if (message.logs != null && message.logs.length)
            for (var i = 0; i < message.logs.length; ++i)
                $root.Log.encode(message.logs[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
    ...
    LogGroup.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.LogGroup();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    LogGroup.fromObject = function fromObject(object) {
        if (object instanceof $root.LogGroup)
            return object;
        var message = new $root.LogGroup();
        if (object.logs) {
            if (!Array.isArray(object.logs))
                throw TypeError(".LogGroup.logs: array expected");
            message.logs = [];
            for (var i = 0; i < object.logs.length; ++i) {
                if (typeof object.logs[i] !== "object")
                    throw TypeError(".LogGroup.logs: object expected");
    ...
    LogGroup.toObject = function toObject(message, options) {
        ...
        if (message.logs && message.logs.length) {
            ...
            for (var j = 0; j < message.logs.length; ++j)
                object.logs[j] = $root.Log.toObject(message.logs[j], options);
        }
        if (message.reserved != null && message.hasOwnProperty("reserved"))
...
$root.LogGroupList = (function() {
     ...
     * @static
     * @param {ILogGroupList=} [properties] Properties to set
     * @returns {LogGroupList} LogGroupList instance
     */
    ...
    LogGroupList.encode = function encode(message, writer) {
        ...
        if (message.logGroupList != null && message.logGroupList.length)
            for (var i = 0; i < message.logGroupList.length; ++i)
                $root.LogGroup.encode(message.logGroupList[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        return writer;
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {LogGroupList} LogGroupList
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    LogGroupList.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.LogGroupList();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    LogGroupList.toObject = function toObject(message, options) {
        ...
        if (message.logGroupList && message.logGroupList.length) {
            ...
            for (var j = 0; j < message.logGroupList.length; ++j)
                object.logGroupList[j] = $root.LogGroup.toObject(message.logGroupList[j], options);
        }
        return object;
    };
